...
public class MailClient {
    ...
    public void sendAsyncAuthenticationMail(String toEmail, String authenticationCode) {
        ...
        log.info("[메일] 메일 전송={}, 시도 횟수 {}/{}", toEmail, ++retryCount, RETRY_MAX_ATTEMPTS);
    ...
    @Recover
    private void occurMailServerError(MailSendException ex) {
        log.error("[메일] 메일 서버에 메일을 보내는 데 실패했습니다. 예외 메시지: {}", ex.getMessage(), ex);
    }
