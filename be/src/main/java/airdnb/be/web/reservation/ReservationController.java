...
public class ReservationController {
    ...
    public ApiResponse<ReservationResponse> reserve(@RequestBody @Valid ReservationAddRequest request) {
        ReservationResponse response = reservationService.reserve(request.toServiceRequest());
